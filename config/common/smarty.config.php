...
define('_SMARTY_ROOT',_VENDOR_PATH.'Smarty/Smarty/');
...
define('_SMARTY_TEMPLATE_DIR',_VIEW_PATH); 							//模版存放路径
define('_SMARTY_COMPILE_DIR',_VAR_PATH.'templates_c/');				//模版编译路径,单独提出方便清理
define('_SMARTY_CONFIG_DIR',_SMARTY_ROOT.'config/');				//模版config路径
define('_SMARTY_CACHE_DIR',_VAR_PATH.'cache/');						//模版config路径
define('_SMARTY_PLUGIN_DIR',_APP_PATH.'smarty_plugin/');						//模版config路径
